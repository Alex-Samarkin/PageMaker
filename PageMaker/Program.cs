...
namespace PageMaker
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            /// что еще?
            /// можно перейти в оформлении на таблицу стилей
            /// можно делать вывод в директорию
            /// можно добавить чтение строк из файла
            /// можно добавить вставку картинок, ссылок и т.п.
            ///
            /// можно добавить таблицы и списки
            ///
            /// можно добавить генератор svg картинок программно :)
        }
    }
}
